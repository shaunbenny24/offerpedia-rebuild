function resize(){
    ...
    function equalCard(){
        var h = 0;
        $('.small-card h4').height('auto');
        $('.small-card h4').each(function(){
            var height = $(this).height();
            if(height > h){
                h = height;
            }
        });
        $('.small-card h4').height(h);
    }
    equalCard();
} 
    ...
    if (valid){
        ...
        jQuery.ajax({
            ...
            success : function(data) { 
                ...
                var stable = data['stable'];
                var pk = data['pk'];
                var account_page = data['account_page'];
                ...
                if (status == 'true') {
                    ...
                    if(noPopup){
                        ...
                        if (account_page == "true"){
                            ...
                            notification.find('.note').text(message);
...
$(document).on('click','.popupbg,.errorPopup span.cancel',function(){
    $('.errorPopup').addClass('hidden fadeOutUp');
    $('.errorPopup').removeClass('fadeInUp');
