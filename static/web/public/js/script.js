function resize(){
    ...
    function equalCard(){
        var h = 0;
        $('#middle .widget').height('auto');
        $('#middle .widget').each(function(){
            var height = $(this).height();
            if(height > h){
                h = height;
            }
        });
        $('#middle .widget').height(h);
    }
    equalCard();

    function equalCard2(){
        var h = 0;
        $('#bottom .widget').height('auto');
        $('#bottom .widget').each(function(){
            var height = $(this).height();
            if(height > h){
                h = height;
            }
        });
        $('#bottom .widget').height(h);
    }
    equalCard2();

    function equalCard3(){
        var h = 0;
        $('#main .widget').height('auto');
        $('#main .widget').each(function(){
            var height = $(this).height();
            if(height > h){
                h = height;
            }
        });
        $('#main .widget').height(h);
    }
    equalCard3();
}  
